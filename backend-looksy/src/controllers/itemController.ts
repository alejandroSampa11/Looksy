 ...
 *         description: Error del servidor
 */
const getAllItemsLimit50 = async (req: Request, res: Response): Promise<void> => {
  try {
...
const createItem = async(req: Request, res: Response): Promise<void> => {
    try {
        const {nombre, categoria, precio, stock, descripcion,urlImage} = req.body;
        const missingFields = [];
...
export {createItem, obtenerItemConSimilares, getItemById, getItemsByCategory, getAllItemsLimit50} 